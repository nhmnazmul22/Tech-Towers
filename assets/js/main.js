...
/*================================tap contant aniamation==========================================*/
const tapLinks = document.getElementsByClassName("nav-link");
const tapContents = document.getElementsByClassName("tab-pane");

function onpentap(tapName) {
